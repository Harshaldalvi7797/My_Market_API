                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                        ...
                                        <td align="center" style="padding:0px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 17px;font-style:sans-serif;">
                                                <cite dir="rtl" lang="ar">
                                                    تنبيه: لقد وصل منتجك "اسم المنتج"  إلى نقطة إعادة الطلب
                                                </cite>
                                                </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr align="center" valign="top">
                                        <td>
                                        <a href="https://mmseller.datavivservers.in/product/variant/${data._id}" style="text-decoration: none"><button class="button" style="width: 34%;"> <cite dir="rtl" lang="ar">
                                                عرض المنتج
                                                </cite>
                                            </button></a>
                                        </td>
