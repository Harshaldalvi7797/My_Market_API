                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="${HOST_NAME}/customerEnglishAssets/google_play.png" alt=""
                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                Thank you for subscribing to My Market newsletter!
                                                <br />Stay tuned for updates on our products and services!
                                            </p>
                                        </td>
                                    </tr>
                                    <!-- Button -->
                                    <!-- <tr align="center" valign="top">
                                        <td>
                                            <button class="button">View Wallet</button>
                                        </td>
                                    </tr> -->
                                    <!-- <tr>
                                        <td align="center" style="padding:-4px 0 30px 0;">
                                            <img src="${HOST_NAME}/customerEnglishAssets/MMExports/1x/Asset_20.png" alt="Not Found Image" width="200"
                                                style="height:auto;display:block;" />
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <img src="${HOST_NAME}/customerEnglishAssets/MMExports/1x/Asset_14.png" alt="Image Not Found" width="300"
                                                style="height:auto;display:block;" />
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 15px;font-style:sans-serif;">
                                                www.mymarketshopping.com &nbsp;<img src="${HOST_NAME}/customerEnglishAssets/insta.png" alt="Not Found Image"
                                            ...
                                            <p style="color: #BEBEBE; font-size: 12px;font-style:sans-serif;">Office 127, Avenue 44, Block 243 Arad - Kingdom of Bahrain
                                               <br> P.O. Box 50066
                                                <br>To Unsubscribe <span style="color:#8fbdb9;">Click here</span>
                                            </p>
                                        </td>
                                    </tr>
                                                ...
                                                <tr>
                                                    <td style="width:150px;padding:0;vertical-align:top;">
                                                        <p style="font-size:16px;line-height:24px; ">
                                                            <img src="${HOST_NAME}/customerEnglishAssets/app_store.png" alt="Not Found Image" width="150"
                                                                style="height:auto;display:block ;float: right;" /></p>
                                                    </td>
                                                    <td style="width:150px;padding:0;vertical-align:top;">
                                                        <p style="font-size:16px;line-height:24px;">
                                                            <img src="${HOST_NAME}/customerEnglishAssets/google_play.png" alt="Not Found Image" width="150"
