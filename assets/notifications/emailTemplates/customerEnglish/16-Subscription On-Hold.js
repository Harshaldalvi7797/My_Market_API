            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;">Subscription On-Hold
                                </p>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                Your subscription to ${data.productname} is on hold. For more information, please contact ${data.sellername}                                  </p>
                                        </td>
                                    </tr>
                                    <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href="${Web_Link}/brand/${data.productVariantId.sellerId._id}" style="text-decoration: none"><button class="button" style="width: 34%;">Contact Seller</button></a>
                                        </td>
                                    </tr>
                                    <!-- <tr>
