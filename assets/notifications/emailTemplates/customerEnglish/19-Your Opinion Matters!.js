                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="${HOST_NAME}/customerEnglishAssets/MMExports/1x/Asset_15.png" alt=""
                                    style="height:auto;display:block;margin-top:-175px;width: 50%;" />
                                <p style="color: white; font-size: 40px; margin: auto;padding-top: 10px;">Your Opinion <b>Matters!</b></p>
                            </td>
                        </tr>
                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                Thank you for shopping with us! It would be greatly appreciated if you
                                                could spare a few moments to leave us a review in order to help us
                                    ...
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href="${Web_Link}/product/${data.productVariantId}" style="text-decoration: none"><button class="button">Add Review
                                            </button></a>
                                        </td>
                                    </tr>
                                    <!-- insta & site link -->
