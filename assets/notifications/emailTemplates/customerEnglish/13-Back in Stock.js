            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;">Back in Stock
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                ${data.productname} is back in stock. You can buy now!
                                            </p>
                                        </td>
                                    </tr>
                                    <!-- Button -->
                                    ...
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href="${Web_Link}/product/${data.productVariantId._id}" style="text-decoration:none"><button class="button" style="width: 34%;">View Product
                                            </button></a>
                                        </td>
                                    </tr>
                                    <!-- <tr>
