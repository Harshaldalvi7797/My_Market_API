                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="${HOST_NAME}/customerEnglishAssets/MMExports/1x/Asset_10.png" alt=""
                                    style="height:auto;display:block;margin-top:-175px;width: 50%;" />
                                <p style="color: white; font-size: 40px; margin: auto;padding-top: 10px;">Admin <b>Message!</b>
                                </p>
                            </td>
                        </tr>
                        <!-- <tr>
                            <td align="center" style="padding:40px 0 0px 0;">
                                <img src="${HOST_NAME}/customerEnglishAssets/MMExports/1x/Asset_13.png" alt=""
                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 70px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                You’ve received a new message from My Market
                                            </p>
                                        </td>
                                    </tr>
                                    <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                            <button class="button" style="width: 34%;">View Message</button>
                                        </td>
                                    </tr>
                                    <!-- <tr>
                                    ...
                                    <!-- <tr>
                                        <td align="center" style="padding:-4px 0 30px 0;">
                                            <img src="${HOST_NAME}/customerEnglishAssets/New folder/New folder/2x/Asset_1@2x.png" alt="" width="200"
                                                style="height:auto;display:block;" />
