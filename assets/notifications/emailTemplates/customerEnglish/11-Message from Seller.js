                    ...
                    <table role="presentation"
                        ...
                        <!-- <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="${HOST_NAME}/customerEnglishAssets/MMExports/1x/Asset 16.png" alt=""
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;">Message from Seller
                                </p>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                You’ve received a new message from ${data.sellername}
                                            </p>
                                        </td>
                                    </tr>
                                    <!-- Button -->
