           ...
           <tr>
               ...
               <td align="center" style="padding:0;">
                   <table role="presentation"
                       ...
                       <tr>
                           <td align="center">
                               <p style="color:#8fbdb9; font-size: 50px; margin: auto;">Forgot <b>Password?</b>
                               </p>
                           </td>
                       </tr>
                       <tr>
                           ...
                           <td style="padding:36px 30px 42px 30px;">
                               <table role="presentation"
                                   ...
                                   <tr align="center" valign="top">
                                       <td>
                                           <a href="${data.link}" style="text-decoration: none"><button class="button" style="width: 34%;">Reset Password</button></a>
                                       </td>
                                   </tr>
                                   <!-- <tr>
