                    ...
                    <table role="presentation"
                        ...
                        <!-- <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="${HOST_NAME}/customerEnglishAssets/MMExports/1x/Asset_16.png" alt=""
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;">New <b>Subscription!</b>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                Thank you! Your subscription to the product ${data.productname} has been
                                                activated successfully and will be delivered to you based on the information provided.
                                            </p>
                                        </td>
                                    </tr>
                                    <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href='${Web_Link}/personal-information' style="text-decoration: none;"><button class="button" style="width: 37%;">View Subscriptions</button></a>
                                        </td>
                                    </tr>
                                    <!-- <tr>
