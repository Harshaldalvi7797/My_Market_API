module.exports = async (req, data) => {
    ...
    for(let item of data.orderItems){
        orderItems+=`<tr>
            ...
            <td style="width: 25%; text-align: left;padding-left: 10px;">
                <p> ${item.productVariantDetails[0].productVariantName}<br><span style="font-size: 12px;">Sold by: ${data.sellerId.nameOfBussiness}</span></p>
            </td>
    ...
    let customer_address= `${data.orderId.customerDelhiveryDetails.billingDetails.addressLine1}${data.orderId.customerDelhiveryDetails.billingDetails.addressLine2?'<br>'+data.orderId.customerDelhiveryDetails.billingDetails.addressLine2:''}${data.orderId.customerDelhiveryDetails.billingDetails.addressLine3?'<br>'+data.orderId.customerDelhiveryDetails.billingDetails.addressLine3:''}${data.orderId.customerDelhiveryDetails.billingDetails.city?'<br>'+data.orderId.customerDelhiveryDetails.billingDetails.city:''}
    ${data.orderId.customerDelhiveryDetails.billingDetails.state?'<br>'+data.orderId.customerDelhiveryDetails.billingDetails.state:''} ${data.orderId.customerDelhiveryDetails.billingDetails.pincode?data.orderId.customerDelhiveryDetails.billingDetails.pincode:''}`
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" style="width:40%;padding:0;vertical-align:top;">
                                            <p style="font-size:16px;line-height:24px;margin-right: 15px;">
                                                Delivery Date/Time:<br>${data.shippingStatus.createdAt.toLocaleString()}<br><br>Payment
                                                Type:<br>${data.orderId.paymentMethod}<br><br>Signed by:<br>"Name of Reciever"
                                            </p>
                                        </td>
                                    </tr>
                                            ...
                                            <table role="presentation" style="width:80%;border-collapse:collapse;">
                                                <tr>
                                                    <td >
                                                        ...
                                                        Notice any issue with your order?
                                                        <span style="color: #8fbdb9;">Return here</span> 
                                                    </p>
