                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="${HOST_NAME}/sellerEnglishAssets/MMExports/1x/Asset_10.png" alt=""
                        ...
                        <tr>
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <!-- <tr>
                                        <td align="center" style="padding:-4px 0 30px 0;">
                                            <img src="${HOST_NAME}/sellerEnglishAssets/New folder/New folder/2x/Asset_1@2x.png" alt="" width="200"
                                                style="height:auto;display:block;" />
