            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center" style="padding:70px 0 70px 0;background:#8fbdb9;">
                                <!-- <img src="${HOST_NAME}/sellerEnglishAssets/MMExports/1x/Asset_15.png" alt=""
                                    style="height:auto;display:block;margin-top:-175px;width: 50%;" /> -->
                                <p style="color: white; font-size: 40px; margin: auto;padding-top: 10px;">Advertisement <b>Request!</b></p>
                            </td>
                        </tr>
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                Thank you for your request. Regrettably, your request was not fulfilled.
                                                Please contact our Customer Care for more information.
                                            </p>
                                        </td>
                                    </tr>
                                    <table class="box" style="width:50%;  align-items: center; margin-left: 125px; color: #BEBEBE;" >
                                        <tr align="center">
                                          <td class="box">Advertisement ID</td>
                                          <td class="box">${data.indexNo}</td>
                                        </tr>
                                        <tr align="center">
                                          <td class="box">Advertisement Name</td>
                                          <td class="box">${data.campaignName}</td>
                                        </tr>
                                      </table>
                                    <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href="${Web_Link}/messages" style="text-decoration: none"><button class="button">Contact Us</button></a>
                                        </td>
                                    </tr>
                                    <!-- <tr>
