            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;">New Review
                                </p>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td align="center" style="padding:0px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                ${data.customername} added a review on your product ${data.productname}
                                            </p>
                                                <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href="${Web_Link}/product-review" style="text-decoration: none"><button class="button" style="width: 34%;">View Review</button></a>
                                        </td>
                                    </tr>
                                    <!-- <tr>
