           ...
           <tr>
               ...
               <td align="center" style="padding:0;">
                   <table role="presentation"
                       ...
                       <tr>
                           <td align="center">
                               <p style="color:#8fbdb9; font-size: 50px; margin: auto;">Subscription De-Activated
                                   ...
                                   <tr>
                                       <td align="center" style="padding:0px 0 30px 0;">
                                           <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                               Subscription order number ${data.subscriptionnumber} has been deactivated by the customer.
                                           </p>
                                               <!-- Button -->
                                   <tr align="center" valign="top">
                                       <td>
                                           <a href="${Web_Link}/subscription" style="text-decoration: none"><button class="button" style="width: 37%;">View Subscriptions
                                           </button></a>
                                       </td>
                                   </tr>
                                   <!-- <tr>
