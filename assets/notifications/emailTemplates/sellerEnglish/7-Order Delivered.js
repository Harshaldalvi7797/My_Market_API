            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;">Order Delivered   
                                </p>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td align="center" style="padding:0px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                Order number #${data.ordernumber} for ${data.customername} has been delivered  </p>                               </tr>
                                    <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href="${Web_Link}/order" style="text-decoration: none"><button class="button" style="width: 35%;background-color: #dd9f3d;
                                            border: none;color: white;padding: 15px 32px;text-align: center;display: inline-block;text-decoration: none;
                                            font-size: 16px;margin: 4px 2px;cursor: pointer;border-radius: 6px;">View Order
                                            </button></a>
                                        </td>
                                    </tr>
                                    <!-- <tr>
