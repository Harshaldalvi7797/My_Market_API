            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;">Alert: Re-Order Point
                                    ...
                                    <tr>
                                        <td align="center" style="padding:0px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                Alert: Your product ${data.productname} has reached its re-order point.
                                            </p>
                                                <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                        <a href="${Web_Link}/product/variant/${data._id}" style="text-decoration: none"><button class="button" style="width: 34%;">View Product
                                            </button></a>
                                        </td>
                                    </tr>
                                    <!-- <tr>
