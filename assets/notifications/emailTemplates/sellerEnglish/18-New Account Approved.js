                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center" style="padding:40px 0 30px 0;">
                                <img src="${HOST_NAME}/sellerEnglishAssets/logo.png" alt="" width="300" style="height:auto;display:block;" />
                        ...
                        <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="${HOST_NAME}/sellerEnglishAssets/seller.png" alt=""
                                    style="height:auto;display:block;margin-top:-175px;width: 50%;" />
                                <h5 style="color: white; font-size: 40px; margin: auto;">New Account!</h5>
                            </td>
                        </tr>
                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                Welcome "Seller Name" Thank you for choosing MY Market, we are
                                               delighted to have you as a partner. Your account has been approved.
                                                <br/>Your login details: ${data.emailId}
                                            </p>
                                        </td>
                                    </tr>
                                    <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href="${Web_Link}/login" style="text-decoration: none"><button class="button">Sign in</button></a>
                                        </td>
                                    </tr>
                                    <!-- insta & site link -->
                                    <tr>
