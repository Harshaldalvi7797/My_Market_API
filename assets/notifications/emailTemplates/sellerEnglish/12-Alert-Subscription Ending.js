                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center" style="padding:40px 0 30px 0;">
                                <img src="assets/MMExports/2x/Asset_2@2x.png" alt="" width="300"
                        ...
                        <!-- <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="assets/MMExports/1x/Asset_16.png" alt=""
                        ...
                        <!-- <tr>
                            <td align="center" style="padding:40px 0 0px 0;">
                                <img src="assets/MMExports/1x/Asset_13.png" alt=""
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;">Alert: Subscription Ending
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:0px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                Subscription for ${data.productname} with Subscription order number ${data.subscriptionnumber} will end within 3 days. 
                                            </p>
                                                <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href="" style="text-decoration: none"><button class="button" style="width: 37%;">View Subscriptions</button></a>
                                        </td>
                                    </tr>
                                    <!-- <tr>
                                        <td align="center" style="padding:-4px 0 30px 0;">
                                            <img src="assets/MMExports/1x/Asset_20.png" alt="" width="200"
                                                style="height:auto;display:block;" />
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <img src="assets/MMExports/1x/Asset_14.png" alt="" width="300"
                                                style="height:auto;display:block;" />
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 15px;font-style:sans-serif;">
                                                www.mymarketshopping.com &nbsp;<img src="assets/insta.png"
                                                ...
                                                <tr>
                                                    <td style="width:150px;padding:0;vertical-align:top;">
                                                        <p style="font-size:16px;line-height:24px; ">
                                                            <img src="assets/app_store.png" alt="" width="150"
                                                                style="height:auto;display:block ;float: right;" /></p>
                                                    </td>
                                                    <td style="width:150px;padding:0;vertical-align:top;">
                                                        <p style="font-size:16px;line-height:24px;">
                                                            <img src="assets/google_play.png" alt="" width="150"
