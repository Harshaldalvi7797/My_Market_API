            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;">Amount Refunded    
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:0px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                An amount of BD ${data.amount} was refunded to the customer for the following products:
                                    </tr>
    
                                    <h5 style="margin-left: 127px;margin-bottom: 10px;color: #A9A9A9; font-size: 18px;">Order ID:#${data.ordernumber}</h5>
                                    <table class="box" style="width:50%;  align-items: center; margin-left: 125px; color: #BEBEBE;" >
                                        <tr align="center">
                                          <th class="box" style="padding:10px;">Product Name</th>
                                          <th class="box" style="padding:10px;">Product ID</th> 
                                        </tr>
                                        <tr align="center">
                                          <td class="box" style="padding:10px;">${data.productname}</td>
                                          <td class="box" style="padding:10px;">${data.indexNo}</td>
                                        </tr>
                                      </table>
                                    ...
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href="https://mmwebsite.datavivservers.in/personal-information?wallet=true" style="text-decoration: none"><button class="button" style="width: 34%;">View Wallet
                                            </button></a>
                                        </td>
                                    </tr>
                                    <!-- <tr>
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <img src="${HOST_NAME}/sellerEnglishAssets/MMExports/1x/Asset_14.png" alt="" width="300"
                                                style="height:auto;display:block;" />
