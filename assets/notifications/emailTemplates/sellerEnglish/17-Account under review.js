            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;">Account under review
                                </p>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td align="center" style="padding:0px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                Welcome "Seller Name" Thank you for choosing My Market. Your details are getting verified, we will notify you soon.
                                            </p>
                                                <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href="https://mmwebsite.datavivservers.in/" style="text-decoration: none"><button class="button" style="width: 34%;">Visit Website</button></a>
                                        </td>
                                    </tr>
                                    <!-- <tr>
