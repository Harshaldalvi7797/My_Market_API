                    ...
                    <table role="presentation"
                        ...
                        <!-- <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="${HOST_NAME}/sellerEnglishAssets/MMExports/1x/Asset 16.png" alt=""
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;">New Subscription Activated
                                    ...
                                    <tr>
                                        <td align="center" style="padding:0px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                New subscription order received for ${data.productname} with Subscription order number ${data.subscriptionnumber}
                                            </p>
                                                <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href="${Web_Link}/subscription" style="text-decoration: none"><button class="button" style="width: 37%;">View Subscriptions</button></a>
                                        </td>
                                    </tr>
                                    <!-- <tr>
