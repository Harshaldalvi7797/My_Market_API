            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;">Account Rejected
                        ...
                        <tr>
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="left" style="padding:0px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">Hi "Seller Name"</p>
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                We regret to notify you that your application to become a seller has been denied. For more infromation, please contact us.                                        </p>
                                                <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                            <button class="button" style="width: 34%;">Contact Us
