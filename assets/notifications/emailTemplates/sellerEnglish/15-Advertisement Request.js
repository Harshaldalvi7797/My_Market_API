                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                Hi ${data.sellername} Thank you for your request. We are pleased to inform
                                                you that your advertisement has been approved.
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr align="center" valign="top">
                                        <td>
                                            <a href="${Web_Link}/advertise" style="text-decoration: none"><button class="button">View Ad</button></a>
                                        </td>
                                    </tr>
                                    <!-- <tr>
