            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;"><cite dir="rtl" lang="ar">هل نسيت
                                        <b> كلمة السر؟</b></cite>
                                </p>
                            </td>
                        </tr>
                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:0px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 17px;font-style:sans-serif;">
                                                <cite dir="rtl" lang="ar"> لإعادة تعيين كلمة المرور الخاصة بك، اضغط على الزر
                                                    أدناه
                                                </cite> </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr align="center" valign="top">
                                        <td>
                                            <button class="button" style="width: 37%;"><cite dir="rtl" lang="ar"> إعادة تعيين كلمة المرور</cite></button>
                                        </td>
                                    </tr>
                                    <!-- <tr>
