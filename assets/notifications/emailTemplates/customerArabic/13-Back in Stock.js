            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;"><cite dir="rtl" lang="ar">عاد إلى المخزون</cite>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 17px;font-style:sans-serif;">
                                                <cite dir="rtl" lang="ar">"اسم المنتج" عاد في المخزون. يمكنك الشراء الآن!</cite>
                                            </p>
                                        </td>
                                    </tr>
                                    <!-- Button -->
                                    ...
                                    <tr align="center" valign="top">
                                        <td>
                                            <button class="button" style="width: 34%;"><cite dir="rtl" lang="ar">عرض المنتج</cite>
                                            </button>
                                        </td>
                                    </tr>
                                    <!-- <tr>
