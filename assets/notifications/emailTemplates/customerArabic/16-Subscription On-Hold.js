            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;"><cite dir="rtl" lang="ar">الاشتراك معلق</cite>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                        ...
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 17px;font-style:sans-serif;">
                                                <cite dir="rtl" lang="ar">
                                                    تم تعليق اشتراكك في "اسم المنتج". لمزيد من المعلومات ، يرجى الاتصال بـ "اسم البائع"                                            </cite>
                                            </p>
                                        </td>
                                    </tr>
                                    <!-- Button -->
                                    ...
                                    <tr align="center" valign="top">
                                        <td>
                                            <button class="button" style="width: 37%;"><cite dir="rtl" lang="ar">  اتصل بالبائع</cite>
                                            </button>
                                        </td>
                                    </tr>
                                    <!-- <tr>
