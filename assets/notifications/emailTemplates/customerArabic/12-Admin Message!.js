                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="${HOST_NAME}/customerArabicAssets/MMExports/1x/Asset 10.png" alt=""
                        ...
                        <!-- <tr>
                            <td align="center" style="padding:40px 0 0px 0;">
                                <img src="${HOST_NAME}/customerArabicAssets/MMExports/1x/Asset 13.png" alt=""
                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 70px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                <cite dir="rtl" lang="ar">لديك رسالة جديدة من My Market</cite>
                                            </p>
                                        </td>
                                    </tr>
                                    <!-- Button -->
                                    <tr align="center" valign="top">
                                        <td>
                                            <button class="button" style="width: 34%;"><cite dir="rtl" lang="ar">عرض الرسالة</cite></button>
                                        </td>
                                    </tr>
                                    <!-- <tr>
                                    ...
                                    <!-- <tr>
                                        <td align="center" style="padding:-4px 0 30px 0;">
                                            <img src="${HOST_NAME}/customerArabicAssets/New folder/New folder/2x/Asset 1@2x.png" alt="" width="200"
                                                style="height:auto;display:block;" />
