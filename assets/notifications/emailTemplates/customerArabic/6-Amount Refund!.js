                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="${HOST_NAME}/customerArabicAssets/MMExports/1x/Asset 18.png" alt=""
                                    style="height:auto;display:block;margin-top:-175px;width: 50%;" />
                                <p style="color: white; font-size: 40px; margin: auto;padding-top: 10px;"><cite dir="rtl" lang="ar">استرداد <b>المبلغ !</b> </cite></p>
                            </td>
                        </tr>
                            ...
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 17px;font-style:sans-serif;">
                                                <cite dir="rtl" lang="ar">مرحبا "اسم المستخدم" تم استرداد المبلغ للمنتج "اسم المنتج" في محفظتك/بطاقتك.</cite>
                                    ...
                                    <tr align="center" valign="top">
                                        <td>
                                            <button class="button"><cite dir="rtl" lang="ar">عرض المحفظة</cite></button>
                                        </td>
                                    </tr>
                                    <!-- <tr>
