                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="${HOST_NAME}/customerArabicAssets/MMExports/1x/Asset 15.png" alt=""
                                    style="height:auto;display:block;margin-top:-175px;width: 50%;" />
                                <p style="color: white; font-size: 40px; margin: auto;padding-top: 10px;"><cite dir="rtl" lang="ar">رأيك يهمنا!</cite></p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;"><cite
                                                    dir="rtl" lang="ar">
                                                    شكرا للتسوق معنا! سيكون موضع تقدير أن نحصل منكم على بضع لحظات لتقييمكم
                                                    للطلب لمساعدتنا على تحسين منتجاتنا
                                                </cite>
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <img src="${HOST_NAME}/customerArabicAssets/MMExports/1x/Asset 14.png" alt="" width="300"
                                                style="height:auto;display:block;" />
                                    ...
                                    <tr align="center" valign="top">
                                        <td>
                                            <button class="button"><cite dir="rtl" lang="ar"> أضف مراجعة</cite></button>
                                        </td>
                                    </tr>
                                    <!-- insta & site link -->
                                    <tr>
