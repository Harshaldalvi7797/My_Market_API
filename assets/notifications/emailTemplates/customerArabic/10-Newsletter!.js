                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                ...
                                <p style="color: white; font-size: 40px; margin: auto;padding-top: 10px;"><cite dir="rtl"
                                        lang="ar"> النشرة البريدية</cite>
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;"><cite
                                                    dir="rtl" lang="ar">
                                                    شكرًا لك على الاشتراك في نشرتنا البريدية!
                                                    <br>
                                                    ترقبونا بأحدث المنتجات والخدمات
                                                </cite>
