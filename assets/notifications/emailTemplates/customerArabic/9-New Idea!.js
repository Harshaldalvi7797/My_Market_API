                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center" style="padding:40px 0 30px 0;background:#8fbdb9;">
                                <img src="${HOST_NAME}/customerArabicAssets/MMExports/1x/Asset 17.png" alt=""
                                    style="height:auto;display:block;margin-top:-175px;width: 50%;" />
                                <p style="color: white; font-size: 40px; margin: auto;padding-top: 10px;"><cite dir="rtl" lang="ar">مقترح جديد</cite></p>
                            </td>
                        </tr>
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;">
                                                <cite dir="rtl" lang="ar">شكرًا على اقتراحك، سنأخذ ذلك بعين الاعتبار.</cite>
                                            </p>
                                        </td>
                                    </tr>
                                    <!-- Button -->
