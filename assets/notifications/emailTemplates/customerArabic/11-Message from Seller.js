            ...
            <tr>
                ...
                <td align="center" style="padding:0;">
                    <table role="presentation"
                        ...
                        <tr>
                            <td align="center">
                                <p style="color:#8fbdb9; font-size: 50px; margin: auto;"><cite dir="rtl" lang="ar">رسالة من البائع</cite>
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="padding:36px 30px 42px 30px;">
                                <table role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="padding:40px 0 30px 0;">
                                            <p style="color: #BEBEBE; font-size: 18px;font-style:sans-serif;"><cite dir="rtl" lang="ar">
                                                لديك رسالة جديدة من "اسم البائع"
                                            </cite>
