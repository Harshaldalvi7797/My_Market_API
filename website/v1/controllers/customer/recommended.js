...
exports.recommendedProducts = async (req, res) => {
    ...
    return res.send({ totalCount: totalCount, count: recommendedProductsList.length, d: recommendedProductsList })
}
...
exports.recommendedProductsFilter = async (req, res) => {
    ...
    recommendedProducts[0].brands = arraySort(recommendedProducts[0].brands, "brandEnglish");

    return res.send({ count: recommendedProducts.length, d: recommendedProducts })
}