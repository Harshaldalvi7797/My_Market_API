...
exports.justSoldFilter = async (req, res) => {
    try {
        ...
        justSoldProducts[0].brands = arraySort(justSoldProducts[0].brands, "brandEnglish");
...
//             .select(['productVarianttId'])
//             .populate({
//                 path: 'productVarianttId',
...
//             if (el['productVarianttId']) {
//                 sold.push(el['productVarianttId']);
//             }
//         }
