...
exports.trackShipment = async (data)=>{
      ...
      const options = {
            method: 'POST',
            uri: 'http://ws.dev.aramex.net/shippingapi/tracking/service_1_0.svc/json/CreateShipments',
            body: postData,
            json: true,
            headers: {
                  'Content-Type': 'application/json',
...
exports.fetchCities = async (countryCode) => {
      return new Promise((resolve, reject) => {
            ...
            const options = {
                  method: 'POST',
                  uri: 'https://ws.dev.aramex.net/shippingapi.V2/location/Service_1_0.svc/json/FetchCities',
                  body: postData,
                  json: true,
                  headers: {
                        'Content-Type': 'application/json',
